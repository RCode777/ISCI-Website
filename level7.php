...
<body style="background-color: #0f172a;">
    <section id="banner">
        ...
        <br />
        <h1 class="text-center text-sky-400" style="font-size: 2em">Level 7</h1>
        <br>
...
if ( isset($_POST["submit"]) ) {
  ...
  if ( $username == "text/javascript" ) {
    echo "<script>
              Swal.fire({ title: `Mantap!`,
                          text: `Password mu benar`, 
                          icon: `success`,
                          footer: `<a href='level8' style='padding: 10px; background-color: rgb(56 189 248 / 1); color: white; border: box-shadow: 0 0 0 3px transparent; border-radius: 10px;' class='btn btn-primary'><i class='fa-solid fa-play'></i> Continue</a>` });
          </script>";
  } else {
    echo "<script>
