...
<body style="background-color: #0f172a;">
    <section id="banner">
        ...
        <br />
        <h1 class="text-center text-sky-400" style="font-size: 2em">Level 10</h1>
        <br>
        <p class="text-white text-center">Temukan sandi yang tersembunyi di halaman ini yaa, agar dapat lanjut ke
            level
            berikutnya..</p>
        <br />
        ...
        if ($result) {
            echo "<script>
              Swal.fire({ title: `Mantap!`,
                          ...
                          icon: `success`,
                          footer: `<a href='success.php' style='padding: 10px; background-color: rgb(56 189 248 / 1); color: white; border: box-shadow: 0 0 0 3px transparent; border-radius: 10px;' class='btn btn-primary'><i class='fa-solid fa-play'></i> Continue</a>` });
          </script>";
        } else {
            echo "<script>
              Swal.fire('Gagal', 'Skill SQL Injection kamu kurang jago nih :)', 'error');
          </script>";
        }
